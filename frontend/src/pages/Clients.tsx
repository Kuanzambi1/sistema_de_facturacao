...
import { Plus, Search, Edit2, Trash2, User, Building2, Globe, Phone, Mail, MapPin, ExternalLink } from "lucide-react";
                ...
                <tr key={c.id}>
                  ...
                  <td>
                    <div className="flex items-center justify-center gap-1">
                      {c.portalToken && (
                        <Button variant="ghost" size="sm" className="h-7 w-7 p-0 text-blue-600" title="Portal do Cliente"
                          onClick={() => { navigator.clipboard.writeText(`${window.location.origin}/p/${c.portalToken}`); toast.success("Link copiado!"); }}>
